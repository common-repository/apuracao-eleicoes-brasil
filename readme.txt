...
Coloque a apuração das eleições 2018 do Brasil no seu site em tempo real, usando o shortcode `[apuracao]` ou `[twitter_eleicao]`.

== Description ==

Esse plugin mostra em tempo real os dados da apuração 2018 do Brasil em seu WordPress, direto do site do TSE.
